...
array = [[0 for i in range(4)] for i in range(1549)]
      ...
      if scores is None:
        ...
        if not agnostic_mode:     
            if classes[i] in category_index.keys():
                ...
                class_name='N/A'
            if class_name not in how_many_object:
                how_many_object[class_name]=1
            else:
                how_many_object[class_name]=how_many_object[class_name]+1
                display_str='{}: {}%'.format(
                class_name,
                int(100*scores[i]))
            for x in how_many_object:    
                if  class_name in "airplane":
                  array[say][0]=array[say][0]+1
                if  class_name in 'car':
                  array[say][1]=array[say][1]+1
                if  class_name in 'cat':
                  array[say][2]=array[say][2]+1
                if  class_name in 'dog':
                  array[say][3]=array[say][3]+1
            
                #how_many_object[x]=how_many_object[class_name]
                #print(how_many_object[x])
